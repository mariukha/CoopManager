-- ==============================================================================
-- LAB 7: Czyszczenie bazy danych (DROP) - usuwa istniejace obiekty przed ponownym utworzeniem
-- ==============================================================================
...
/
BEGIN EXECUTE IMMEDIATE 'DROP VIEW v_czlonek_bezpieczny'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP MATERIALIZED VIEW mv_dashboard_stats'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP MATERIALIZED VIEW mv_zuzycie_mediow'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
-- ==============================================================================
-- LAB 7: CREATE TABLE - tworzenie tabel z PRIMARY KEY, FOREIGN KEY, DEFAULT
-- Interfejs: Panel Administratora -> zakladki z danymi (Budynki, Mieszkania, itd.)
-- ==============================================================================

-- LAB 7: Tabela budynek - przechowuje dane budynkow spoldzielni
-- Interfejs: Panel Administratora -> Budynki
...
-- LAB 7: Tabela mieszkanie - dane mieszkan z kluczem obcym do budynku
-- Interfejs: Panel Administratora -> Mieszkania
...
-- LAB 7: Tabela pracownik - dane pracownikow spoldzielni
-- Interfejs: Panel Administratora -> Pracownicy
...
-- LAB 7: Tabela uslugi - cennik uslug komunalnych
-- Interfejs: Panel Administratora -> Uslugi
CREATE TABLE uslugi (
...
-- LAB 7: Tabela naprawa - zgloszenia napraw z wieloma kluczami obcymi
-- Interfejs: Panel Administratora -> Naprawy, Portal Mieszkanca -> Moje Naprawy
...
-- LAB 7: Tabela oplata - naliczone oplaty za uslugi
-- Interfejs: Panel Administratora -> Oplaty, Portal Mieszkanca -> Moje Oplaty
CREATE TABLE oplata (
...
-- LAB 7: Tabela uzytkownicy - dane logowania administratorow
...
-- LAB 7: Tabela spotkanie_mieszkancow - harmonogram spotkan
-- Interfejs: Panel Administratora -> Spotkania, Portal Mieszkanca -> Spotkania
...
-- LAB 7: Tabela umowa - umowy najmu i wlasnosci
-- Interfejs: Panel Administratora -> Umowy
CREATE TABLE umowa (
...
-- LAB 7: Tabela konto_spoldzielni - konta bankowe spoldzielni
-- Interfejs: Panel Administratora -> Konta Spoldzielni
...
-- LAB 7 + LAB 13: Tabela log_zmian_czlonka - logi audytu dla triggera
-- Interfejs: Panel Administratora -> Narzedzia Administratora -> Historia zmian
...
-- LAB 7: ALTER TABLE ADD - dodawanie nowych kolumn do istniejacych tabel
-- Interfejs: Panel Administratora -> rozszerzone informacje w formularzach
...
-- ==============================================================================
-- LAB 9: VIEW - widoki proste laczace dane z kilku tabel
-- Interfejs: Panel Administratora -> Raporty
-- ==============================================================================

-- LAB 9: Widok prosty - mieszkania z adresem budynku (JOIN dwoch tabel)
...
-- LAB 9: Widok z agregacja - podsumowanie oplat per mieszkanie (GROUP BY, SUM, COUNT, CASE)
...
-- LAB 9: Widok z CASE - naprawy z opisowym statusem
...
-- LAB 9: Widok dla portalu mieszkanca - oplaty z nazwa uslugi
...
-- LAB 9: Widok zmaterializowany - statystyki dla pulpitu (keszowane dane)
...
-- LAB 9: Widok zmaterializowany - zuzycie mediow per budynek
-- Interfejs: Panel Administratora -> Raporty -> Statystyki mediow
CREATE MATERIALIZED VIEW mv_zuzycie_mediow
BUILD IMMEDIATE
REFRESH FORCE ON DEMAND
AS
SELECT 
    ...
    b.adres,
    u.nazwa_uslugi,
    NVL(SUM(o.zuzycie), 0) AS suma_zuzycia,
    NVL(SUM(o.kwota), 0) AS suma_kwot
FROM budynek b
LEFT JOIN mieszkanie m ON b.id_budynku = m.id_budynku
LEFT JOIN oplata o ON m.id_mieszkania = o.id_mieszkania
LEFT JOIN uslugi u ON o.id_uslugi = u.id_uslugi
GROUP BY b.id_budynku, b.adres, u.nazwa_uslugi;

-- LAB 9: Widok z kolumnami INVISIBLE - ukrywa PESEL i telefon przy SELECT *
...
-- ==============================================================================
-- LAB 10: JOIN - rozne typy polaczen tabel (RIGHT, FULL OUTER, CROSS, SELF)
-- Interfejs: Panel Administratora -> Raporty -> Widoki z JOIN
-- ==============================================================================

-- LAB 10: RIGHT JOIN - wszyscy pracownicy z ich naprawami (nawet bez napraw)
...
-- LAB 10: FULL OUTER JOIN - wszystkie oplaty i uslugi (nawet bez powiazania)
...
-- LAB 10: JOIN 3 tabel - czlonek z mieszkaniem i budynkiem
...
-- ==============================================================================
-- LAB 11: SEQUENCE - generowanie unikalnych identyfikatorow
-- Interfejs: uzywane wewnetrznie przy dodawaniu rekordow
-- ==============================================================================

-- LAB 11: Sekwencja dla spotkan i napraw
...
-- Interfejs: Panel Administratora -> operacje CRUD na czlonkach
-- ==============================================================================
...
-- LAB 11: Procedura z CURSOR - pobiera naprawy wedlug statusu
-- Interfejs: uzywana wewnetrznie w raportach
...
-- LAB 11: Procedura zwiekszania cen uslug o podany procent
...
-- LAB 11: Procedura zglaszania naprawy przez mieszkanca
...
-- LAB 11: Funkcja dodajaca spotkanie - zwraca ID nowego spotkania
...
-- LAB 11: Funkcja aktualizujaca saldo konta spoldzielni
...
-- ==============================================================================
-- LAB 12: PACKAGE - pakiety PL/SQL z procedurami i funkcjami
-- Interfejs: Panel Administratora -> rozne operacje, Raporty
-- ==============================================================================

-- LAB 12: Pakiet coop_pkg - operacje na oplatach i naprawach
-- Interfejs: Narzedzia Administratora, Raporty
...
-- Interfejs: Panel Administratora -> Budynki, Raporty
...
-- ==============================================================================
-- LAB 13: TRIGGER - wyzwalacze automatyczne na tabelach
-- Interfejs: Narzedzia Administratora -> Historia zmian (logi audytu)
-- ==============================================================================
...
-- Interfejs: automatyczna walidacja przy dodawaniu/edycji oplat
...
-- ==============================================================================
-- LAB 13: EXECUTE IMMEDIATE - dynamiczny SQL
...
-- ==============================================================================
-- LAB 7: INSERT - dane testowe do tabel
-- Interfejs: widoczne we wszystkich zakladkach po zalogowaniu
-- ==============================================================================
